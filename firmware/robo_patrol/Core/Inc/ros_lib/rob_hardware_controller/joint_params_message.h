#ifndef _ROS_rob_hardware_controller_joint_params_message_h
#define _ROS_rob_hardware_controller_joint_params_message_h
...
namespace rob_hardware_controller
{
  ...
  class joint_params_message : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "rob_hardware_controller/joint_params_message"; };
    virtual const char * getMD5() override { return "41f154fb8ac4d2f58bc7aa5b459360f4"; };
