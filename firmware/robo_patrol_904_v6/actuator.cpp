...
void ACTUATOR::setMaxRPM(int max_rpm)
{
    _max_rpm = max_rpm;
}

void ACTUATOR::writePWM(int pwm)
{
    _pwm_cntrl = pwm;
}

void ACTUATOR::writeRPM(int rpm)
{
    _pwm_cntrl = (((double)rpm / (double)_max_rpm) * 255);
}
